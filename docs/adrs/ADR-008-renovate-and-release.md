...
**Status:** Accepted (amended by [ADR-016](ADR-016-ci-split-build-and-validation.md), [ADR-018](ADR-018-artifact-taxonomy.md), [ADR-021](ADR-021-no-self-hosted-runners.md))
**Date:** 2026-05-10
**Amended:** 2026-05-15 — runner topology revised by ADR-016; artifact taxonomy, naming grammar, and release-dependency flow specified by ADR-018. 2026-05-16 — ADR-021 forbids self-hosted runners entirely.
